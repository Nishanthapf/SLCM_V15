...
def run_fix():
    file_path = "/home/apfd/Education_V15/apps/slcm/slcm/slcm/doctype/student_master/student_master_workflow.json"
    ...
    for action_name in all_actions:
        if not frappe.db.exists("Workflow Action Master", action_name):
            try:
                ...
                action = frappe.get_doc({"doctype": "Workflow Action Master", "workflow_action_name": action_name})
                action.insert()
