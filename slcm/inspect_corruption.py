...
def execute():
    ...
    docs = frappe.get_all("Student Master", filters={"aadhaar_card": ["like", f"%{file_part}%"]}, fields=["name", "aadhaar_card", "pan_card", "std_x_marksheet"])
    ...
    props = frappe.get_list("Property Setter", filters={"doc_type": "Student Master", "field_name": "aadhaar_card"}, fields=["property", "value"])
    ...
    props_x = frappe.get_list("Property Setter", filters={"doc_type": "Student Master", "field_name": "std_x_marksheet"}, fields=["property", "value"])
